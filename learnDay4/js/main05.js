...
const CANVAS_WIDTH2 = (collisionCanvas.width = window.innerWidth);
const CANVAS_HEIGHT2 = (collisionCanvas.height = window.innerHeight);
...
window.addEventListener("click", function (e) {
  const detecedPixelColor = collisionCtx.getImageData(e.x, e.y, 1, 1);
  const pc = detecedPixelColor.data;
